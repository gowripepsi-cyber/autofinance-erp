...
export default function Header({ branch, setBranch, searchQuery, setSearchQuery }: HeaderProps) {
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-[#cbd5e1]/40">
          ...
          <div className="flex items-center gap-3 pl-1 cursor-pointer group">
            ...
            <div className="hidden lg:block text-left">
              <p className="font-sans text-xs font-semibold text-[#091426] leading-none">Admin User</p>
              <span className="font-sans text-[10px] text-[#45474c] mt-0.5 block leading-none">Executive Level</span>
            </div>
          </div>
        </div>
      </div>
